...
#### Edit range of data
data = yf.download("ALT", start="2025-01-01", end="2025-02-22")

data2 = pd.DataFrame(columns=['close3'])
data2['close3'] = data["Close"]
data2 = pd.DataFrame(data2)

#### Number of days to predict
shift = 3

data2['Prediction'] = data2['close3'].shift(-shift)
#print(data2)
