...
# X is our predicting variables, y is our variable we want to predict
X, y = df.drop('Num_Players', axis=1), df['Num_Players']

# we split the data in 0.8 (train_size), using the first half to train the model and the second half to test.
X_train, X_test, y_train, y_test = train_test_split(X, y, train_size=0.8, shuffle=False)

# CHOOSING OUR BRANCHES #
# --------------------------------------------------------- # 
